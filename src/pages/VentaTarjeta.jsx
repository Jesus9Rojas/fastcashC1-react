                ...
                <div className="relative flex flex-col lg:flex-row gap-6 lg:gap-6 max-w-[1100px] mx-auto">
                    ...
                    <div className="bg-[var(--color-header)] p-6 md:p-8 rounded-[2rem] shadow-sm border border-[var(--border-color)] lg:w-[45%] flex flex-col transition-colors duration-300">
                        <h3 className="text-2xl font-black text-[var(--texto-principal)] mb-6 tracking-tight flex items-center gap-3">
                            <i className="fa-solid fa-bag-shopping text-blue-600"></i> ¿Qué vendiste?
                        </h3>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex flex-col items-center justify-center p-3 sm:p-4 rounded-2xl cursor-pointer transition-colors duration-300 border-2 ${
                                                estaSeleccionada
                                                    ? 'border-blue-600 bg-[var(--color-header)] text-blue-600 shadow-sm z-10'
                                        ...
                                        >
                                            ...
                                            {estaSeleccionada && (
                                                <div className="absolute -top-2 -right-2 w-6 h-6 bg-blue-600 border-2 border-[var(--color-header)] rounded-full flex items-center justify-center shadow-md animate-[popCheck_0.3s_ease-out_forwards]">
                    ...
                    <div className="bg-[var(--color-header)] p-6 md:p-8 rounded-[2rem] shadow-sm border border-[var(--border-color)] lg:w-[55%] flex flex-col transition-colors duration-300 relative">
                        ...
                        <h2 className="text-2xl font-black text-blue-600 mb-6 tracking-tight flex items-center gap-3">
                            <i className="fa-solid fa-money-check-dollar"></i> Pago Tarjeta
                        </h2>

                        <form onSubmit={handleRegistrarVenta} className="flex flex-col flex-grow gap-4">

                            <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-4">

                                <div className="bg-[var(--color-fondo-app)] p-5 rounded-3xl border-2 border-[var(--border-color)] focus-within:border-blue-600 transition-colors duration-300 flex flex-col justify-center min-h-[100px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-wrap gap-3 relative">
                                    {bancos.length === 0 ? (
                                        <p className="text-xs text-[var(--texto-secundario)] animate-pulse">Cargando bancos...</p>
                                    ) : (
                                        <>
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`relative flex items-center justify-center gap-2.5 border-2 px-5 py-3 rounded-xl cursor-pointer font-bold text-sm transition-colors duration-300 flex-1 sm:flex-none ${
                                                            estaSeleccionado
                                                                ? 'border-blue-600 bg-[var(--color-header)] text-[var(--texto-principal)] shadow-sm z-10'
                                                    ...
                                                    >
                                                        ...
                                                        {estaSeleccionado && (
                                                            <div className="absolute -top-2 -right-2 w-5 h-5 bg-blue-600 border-2 border-[var(--color-header)] rounded-full flex items-center justify-center shadow-md animate-[popCheck_0.3s_ease-out_forwards]">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full flex items-center justify-between gap-3 border-2 px-5 py-3 rounded-xl cursor-pointer font-bold text-sm transition-all duration-200 outline-none ${
                                                            isHiddenSelected
                                                                ? 'border-blue-600 bg-[var(--color-header)] text-[var(--texto-principal)] shadow-sm z-10'
                                                                : 'bg-[var(--color-header)] border-[var(--border-color)] text-[var(--texto-secundario)] hover:border-[var(--texto-secundario)]'
                                                        } ${dropdownBancosAbierto ? 'ring-4 ring-blue-600/10 border-blue-600' : ''}`}
                                                    >
                                                        ...
                                                        <i className={`fa-solid fa-chevron-down transition-transform duration-300 text-xs flex-shrink-0 ${dropdownBancosAbierto ? 'rotate-180 text-blue-600' : ''}`}></i>
                                                    </button>
                                                            ...
                                                            {bancosOcultos.map(b => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {isSel && <i className="fa-solid fa-check text-blue-600 text-xs flex-shrink-0"></i>}
                                                                    </button>
                                                                );
                                                            })}
                                                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full py-4 pl-12 pr-4 bg-[var(--color-fondo-app)] border-2 border-[var(--border-color)] focus:border-blue-600 rounded-xl text-[var(--texto-principal)] font-bold outline-none transition-colors tracking-widest placeholder:tracking-normal text-lg placeholder:text-[var(--texto-secundario)]"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="mt-2">
                                <button
                                    ...
                                    className="w-full bg-gradient-to-br from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 text-white font-black tracking-wide text-lg py-4 rounded-2xl shadow-md transition-colors duration-300 flex justify-center items-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed disabled:shadow-none"
                                >
                                    {cargando ? (
